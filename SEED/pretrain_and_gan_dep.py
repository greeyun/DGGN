...
from SEED_dataloader import Mydataset, get_train_test_clip
...
for sub in config.subjectList:
    for clip_num in config.clip_num_list:
        ...
        early_stopping_gan = EarlyStopping_gan(patience=7, verbose=True, dep=True, sub=sub, clip_num=clip_num)
        print('train GAN')
        pretrain_gan_loss = []
        correct = 0
        total_train = 0
